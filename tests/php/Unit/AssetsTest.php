...
final class AssetsTest extends TestCase {
	...
	// testable in a process of its own. The CSS entry is load-bearing: Vite
	...
	//
	// ADR-008 retired the per-pack theme_mod resolution this suite used to cover
	// with a second test (`…_enqueues_the_pack_the_theme_mod_selects`):
	// enqueue_dev() no longer calls get_theme_mod() at all — CSS_ENTRY is a fixed
	// constant, one bundle, nothing left for a theme_mod to select between.
	#[RunInSeparateProcess]
	#[PreserveGlobalState( false )]
	public function test_dev_mode_enqueues_the_style_bundle_from_the_dev_server(): void {
