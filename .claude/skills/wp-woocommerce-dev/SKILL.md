...
Common WooCommerce patterns organized by concern. All examples follow WordPress PHP Coding Standards (spaces in parentheses, Yoda conditions; NOTE project override: `[]` short array syntax, not `array()`).
